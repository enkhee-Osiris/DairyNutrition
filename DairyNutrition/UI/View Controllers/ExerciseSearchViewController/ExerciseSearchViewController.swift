...
class ExerciseSearchViewController: MainViewController, UITableViewDelegate, UITableViewDataSource, UISearchResultsUpdating, UISearchBarDelegate  {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        self.loadListOfExercises(){ finished in
            if finished {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let exerciseInfoViewController = UIStoryboard.mainStoryboard?.instantiateViewController(withIdentifier: "ExerciseDetailsViewController") as! ExerciseDetailsViewController
        
        if shouldShowSearchResults {
            let index = dataArray.indexes(of: filteredArray[row])
            exerciseInfoViewController.exerciseName = jsonObj[index]["name"].string!
            exerciseInfoViewController.exerciseValue = Double(jsonObj[index]["value"].double!)
        }
        else {
//            foodInfoViewController.foodId = jsonObj[row]["id"].string!
            exerciseInfoViewController.exerciseName = jsonObj[row]["name"].string!
            exerciseInfoViewController.exerciseValue = jsonObj[row]["value"].double!
        }
        
        super.pushVC(exerciseInfoViewController)
    }
    ...
    func loadListOfExercises(completion: @escaping (_ finished: Bool) -> ()) {
    ...
    func configureCustomSearchBar() {
        ...
        customSearchBar.placeholder = "Search exercises..."
